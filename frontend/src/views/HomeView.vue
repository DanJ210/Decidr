...
<style scoped>
.case-feed { position: relative; height: calc(100dvh - 10.75rem); min-height: 34rem; margin: -1.25rem -1rem -1.5rem; background: #161b20; color: #fff; }
.case-feed-header { position: absolute; inset: 0 0 auto; z-index: 2; display: flex; align-items: center; gap: .75rem; padding: 1rem; background: linear-gradient(#101419d9, transparent); }.case-feed-branding { display: grid; line-height: 1.1; }.case-feed-branding span { font-size: .72rem; font-weight: 700; text-transform: uppercase; opacity: .7; }.case-feed-branding strong { font-family: 'Newsreader', serif; font-size: 1.1rem; }.case-feed-filters { display: flex; gap: .25rem; margin-left: auto; }.case-feed-filters button, .case-feed-invitation { min-width: 2.35rem; min-height: 2.35rem; border: 1px solid #ffffff5c; border-radius: 5px; background: #151a1db8; color: #fff; font-size: .74rem; font-weight: 700; cursor: pointer; }.case-feed-filters button.active { border-color: var(--signal); background: var(--signal); color: var(--ink); }.case-feed-invitation { display: inline-flex; align-items: center; justify-content: center; gap: .25rem; text-decoration: none; }
.case-feed-viewport { height: 100%; overflow-y: auto; scroll-snap-type: y mandatory; overscroll-behavior-y: contain; scrollbar-width: none; }.case-feed-viewport::-webkit-scrollbar { display: none; }.case-feed-item { position: relative; height: 100%; scroll-snap-align: start; scroll-snap-stop: always; overflow: hidden; }.case-feed-media, .case-feed-media video, .case-feed-no-video, .case-feed-shade { position: absolute; inset: 0; width: 100%; height: 100%; }.case-feed-media video { object-fit: cover; background: #202830; }.case-feed-no-video { display: grid; place-content: center; gap: .7rem; padding: 4rem 2rem; background: linear-gradient(140deg, #2557d6, #182a42 55%, #b83a36); text-align: center; }.case-feed-no-video span { font-size: .76rem; font-weight: 700; text-transform: uppercase; }.case-feed-no-video p { max-width: 28rem; margin: 0; font-family: 'Newsreader', serif; font-size: 1.6rem; line-height: 1.15; }.case-feed-shade { background: linear-gradient(180deg, #0d11162b 25%, #0d111659 48%, #0d1116f2 100%); pointer-events: none; }
.case-feed-content { position: relative; z-index: 1; height: 100%; display: flex; flex-direction: column; justify-content: end; padding: 5.25rem 1rem 1rem; }.case-feed-topline { display: flex; justify-content: space-between; gap: 1rem; margin-bottom: auto; font-size: .72rem; font-weight: 700; text-transform: uppercase; }.case-feed-topline span { padding: .28rem .45rem; border: 1px solid #ffffff73; border-radius: 4px; background: #11161a99; }.case-feed-copy { max-width: 38rem; }.case-feed-copy > p:first-child { display: flex; align-items: center; gap: .35rem; margin: 0 0 .35rem; font-size: .77rem; font-weight: 700; }.case-feed-copy i { width: .45rem; height: .45rem; border-radius: 50%; background: var(--side-a); }.side-b .case-feed-copy i { background: var(--side-b); }.case-feed-copy h1 { margin: 0; font-family: 'Newsreader', serif; font-size: clamp(1.8rem, 8vw, 3rem); line-height: .98; }.case-feed-copy > p:last-child { margin: .6rem 0 0; color: #ffffffd1; font-size: .88rem; }.case-feed-sequence { display: grid; grid-template-columns: auto 1fr auto; align-items: center; gap: .5rem; margin: 1.05rem 0; }.case-feed-sequence button { border: 0; padding: 0; background: transparent; color: #ffffffa8; cursor: pointer; font-size: .76rem; font-weight: 700; }.case-feed-sequence button span { margin-right: .3rem; color: var(--signal); }.case-feed-sequence button.active { color: #fff; }.case-feed-sequence button:disabled { cursor: default; opacity: .45; }.case-feed-sequence i { height: 1px; background: #ffffff75; }.case-feed-actions { display: grid; gap: .8rem; }.case-feed-playback { display: flex; gap: .45rem; }.case-feed-playback button, .case-feed-playback a { display: inline-grid; place-items: center; width: 2.6rem; height: 2.6rem; border: 1px solid #ffffff6b; border-radius: 50%; background: #11161a9e; color: #fff; cursor: pointer; }
.case-feed-vote-area { display: grid; grid-template-columns: 1fr auto 1fr; align-items: center; gap: .55rem; min-height: 3.25rem; }.case-feed-vote { display: flex; align-items: center; justify-content: center; gap: .4rem; min-height: 3.25rem; border: 0; border-radius: 5px; color: #fff; cursor: pointer; font-size: .82rem; font-weight: 800; }.case-feed-vote:disabled { cursor: not-allowed; opacity: .45; }.case-feed-vote.side-a { background: var(--side-a); }.case-feed-vote.side-b { background: var(--side-b); }.case-feed-vote-area > p { margin: 0; color: #ffffffbd; font-size: .69rem; font-weight: 700; text-align: center; text-transform: uppercase; }.case-feed-verdict { grid-column: 1 / -1; display: grid; grid-template-columns: auto 1fr auto; gap: .55rem; align-items: center; }.case-feed-verdict > div:first-child, .case-feed-verdict > div:last-child { display: grid; gap: .1rem; font-size: .68rem; }.case-feed-verdict > div:last-child { text-align: right; }.case-feed-verdict strong { font-size: 1.05rem; }.case-feed-meter { height: .55rem; overflow: hidden; border-radius: 999px; background: var(--side-b); }.case-feed-meter span { display: block; height: 100%; background: var(--side-a); }.case-feed-result-note { grid-column: 1 / -1; margin: -.25rem 0 0; color: #ffffffc7; font-size: .7rem; text-align: center; }.case-feed-notice { display: grid; place-items: center; height: 100%; margin: 0; padding: 2rem; color: #fff; text-align: center; }.case-feed-notice.error { background: #5f2321; }
@media (min-width: 900px) { .case-feed { height: calc(100dvh - 7.75rem); margin: -1.5rem 0; border: 1px solid var(--line); border-radius: 8px; }.case-feed-content, .case-feed-header { padding-inline: 2rem; } }
</style>
